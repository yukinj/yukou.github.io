...
# time O(2N) space O(1)
"""
main idea: get the length of LList and connect tail with head. find tail and set tail.next to None to cut off the connection to new head of rotated LList 
...
"""
    def rotateRight(self, head: ListNode, k: int) -> ListNode:
        ...
        p = ps = res = head 
        cnt = 1
        # find the tail and get length of LList  
        while p.next:
            p = p.next
            cnt += 1
